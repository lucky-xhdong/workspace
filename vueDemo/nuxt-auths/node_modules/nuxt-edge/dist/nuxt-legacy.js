/*!
 * nuxt-legacy-edge v2.0.0-25609473.c77fa47 (c) 2016-2018
...
Options.from = function (_options) {
  ...
  options.rootDir = hasValue(options.rootDir) ? options.rootDir : process.cwd(); // Apply defaults by ${buildDir}/dist/build.config.js
  ...
  ___default.defaultsDeep(options, defaults); // Resolve dirs


  options.srcDir = hasValue(options.srcDir) ? path__default.resolve(options.rootDir, options.srcDir) : options.rootDir;
  options.buildDir = path__default.resolve(options.rootDir, options.buildDir); // Populate modulesDir
...
var name = "nuxt-edge";
var version = "2.0.0-25609473.c77fa47";
...
function () {
  ...
  _createClass(StyleLoader, [{
    ...
    value: function css(options) {
      ...
      var cssLoaderAlias = (_cssLoaderAlias = {}, _defineProperty(_cssLoaderAlias, "/".concat(this.assetsDir), path__default.join(this.srcDir, this.assetsDir)), _defineProperty(_cssLoaderAlias, "/".concat(this.staticDir), path__default.join(this.srcDir, this.staticDir)), _cssLoaderAlias);
      return {
...
function () {
  ...
  _createClass(WebpackBaseConfig, [{
    ...
    value: function alias() {
      ...
      return _ref = {
        '~': path__default.join(this.options.srcDir),
        '~~': path__default.join(this.options.rootDir),
        '@': path__default.join(this.options.srcDir),
        '@@': path__default.join(this.options.rootDir)
      }, _defineProperty(_ref, this.options.dir.assets, path__default.join(this.options.srcDir, this.options.dir.assets)), _defineProperty(_ref, this.options.dir.static, path__default.join(this.options.srcDir, this.options.dir.static)), _ref;
    }
  }, {
    key: "rules",
  ...
  _createClass(WebpackClientConfig, [{
    ...
    value: function extendConfig() {
      ...
      if (!this.options.dev && !config.optimization.minimizer) {
        config.optimization.minimizer = []; // https://github.com/webpack-contrib/uglifyjs-webpack-plugin

        var uglifyJsPlugin = new UglifyJsWebpackPlugin({
          parallel: true,
        ...
        config.optimization.minimizer.push(uglifyJsPlugin); // https://github.com/NMFR/optimize-css-assets-webpack-plugin
                  ...
                  regeneratorRuntime.mark(function _callee4(p) {
                    ...
                    return regeneratorRuntime.wrap(function _callee4$(_context4) {
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            ext = path__default.extname(p.src) ? '' : '.+([^.])';
                            _context4.next = 3;
...
function () {
  function Generator(nuxt, builder) {
    ...
    this.distPath = path__default.resolve(this.options.rootDir, this.options.generate.dir);
