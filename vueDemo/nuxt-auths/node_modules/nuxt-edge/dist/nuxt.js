/*!
 * nuxt-edge v2.0.0-25609473.c77fa47 (c) 2016-2018
...
class StyleLoader {
  ...
  css(options) {
    ...
    const cssLoaderAlias = {
      [`/${this.assetsDir}`]: path__default.join(this.srcDir, this.assetsDir),
      [`/${this.staticDir}`]: path__default.join(this.srcDir, this.staticDir)
    };
...
class WebpackBaseConfig {
  ...
  alias() {
    return {
      ...
      '@': path__default.join(this.options.srcDir),
      '@@': path__default.join(this.options.rootDir),
      [this.options.dir.assets]: path__default.join(
        this.options.srcDir,
        this.options.dir.assets
      ),
      [this.options.dir.static]: path__default.join(
        this.options.srcDir,
...
class Builder {
  ...
  async webpackBuild() {
    ...
    await Promise.all(this.plugins.map(async (p) => {
      const ext = path__default.extname(p.src) ? '' : '.+([^.])';
